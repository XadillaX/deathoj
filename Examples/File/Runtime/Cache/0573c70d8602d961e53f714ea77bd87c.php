...
<div class="image">
 ...
 <tr>
    <td width="126" rowspan="2"><img src="__PUBLIC__/Uploads/m_<?php echo ($vo["image"]); ?>" /></td>
    <td width="64">&nbsp;</td>
  </tr>
  <tr>
    <td><img src="__PUBLIC__/Uploads/s_<?php echo ($vo["image"]); ?>" /></td>
  </tr>
...
<tr>
	...
	<div class="result" style="background:#E9E9F3">上传允许文件类型：gif png jpg 图像文件，分别生产2张缩略图。并且把原图删掉,点击稍大的图将会在新窗口中显示带水印的图片</div>
	</td>
</tr>
<tr>
